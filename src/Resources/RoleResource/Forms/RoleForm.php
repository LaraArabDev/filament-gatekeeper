...
namespace LaraArabDev\FilamentGatekeeper\Resources\RoleResource\Forms;
...
class RoleForm
{
     ...
     */
    public static function getPermissionTypeConfig(): array
    {
        return [
    ...
    /** @return array<string> Types that show "Entity — Type" in section title */
    public static function getTypesWithEntityInTitle(): array
    {
     ...
     */
    public static function getGroupedPermissionsSection(string $type): array
    {
        $guard = config('gatekeeper.guard', 'web');
    ...
    /**
     * Build a single section for one entity group.
     *
     * @param  Collection<int, Permission>  $perms
     */
    public static function makeSectionForEntity(
        string $entityKey,
        Collection $perms,
        string $type,
        string $typeLabel,
    ...
    public static function makeEmptyPermissionsPlaceholder(): Section
    {
        return Section::make()
            ->schema([
    ...
    public static function formatPermissionLabel(string $permissionName, string $entityKey): string
    {
        return str($permissionName)->replace('_', ' ')->headline()->toString();
    }

    public static function getModelPath(string $entityName, string $type): string
    {
    ...
    public static function getEntityIcon(string $type): string
    {
        return match ($type) {
